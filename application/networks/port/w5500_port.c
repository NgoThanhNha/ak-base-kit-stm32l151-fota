 ...
 ******************************************************************************
 * @file: w5500_port.c
 * @brief: WIZCHIP Config Source File
 * @date: 2013/10/21
 * @version: 1.0.1
...
_WIZCHIP WIZCHIP = {
    _WIZCHIP_IO_MODE_,           /* host interface mode */
    _WIZCHIP_ID_ ,               /* wizchip id */ 
   {  
      wizchip_cris_enter,        /* crtical section enter function */
      wizchip_cris_exit          /* crtical section exit function */
   },
   {
      wizchip_cs_select,         /* wizchip select */ 
      wizchip_cs_deselect        /* wizchip deselect */
   },
   {
      {
         wizchip_bus_readdata,   /* wizchip read data function */
         wizchip_bus_writedata   /* wizchip write data function */
      },
